...
export async function POST(req: NextRequest) {
  try {
    const { to, nombre, pdfBase64, numeroPresupuesto, origen, destino, fecha, precio } = await req.json()
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #1e3a5f; padding: 24px; border-radius: 8px 8px 0 0;">
            <h1 style="color: white; margin: 0; font-size: 24px;">🚌 Busvio</h1>
          ...
          <div style="background: white; padding: 32px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 8px 8px;">
            ...
            <div style="background: #f8fafc; border-radius: 8px; padding: 20px; margin: 24px 0; border-left: 4px solid #1e3a5f;">
              ...
              <p style="margin: 8px 0 0 0; color: #1e3a5f; font-size: 18px; font-weight: bold;">Total: ${precio} €</p>
            </div>
            ...
            <p style="color: #94a3b8; font-size: 12px; margin: 0;">Busvio — Gestión de transporte discrecional</p>
          </div>
        </div>
      `,
      attachments: [
